...
namespace ExtensionMethod
{
   ...
   {
      /// <summary>
      /// Clone properties using reflection, not apply for property is IEnumerable
      /// </summary>
      /// <typeparam name="TModel">Type of model to clone</typeparam>
      /// <param name="dataDest">Destination model copy to</param>
      /// <param name="dataSource">Source model to copy from</param>
